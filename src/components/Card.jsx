...
import { View,Text,StyleSheet,Image, ScrollView,ImageBackground ,Dimensions} from 'react-native';
 const Card = (props) => {
  ...
  return (
    <View style={{margin:8}}>
    <ImageBackground source={(props.data.type==="green")?require(`../../assets/media/creditcard.png`):require(`../../assets/media/creditcard2.png`) }
    imageStyle={props.lower? allstyles.imageBack:allstyles.imageBackLoweOpacity}>
      ...
      <View style={{width:windowWidth*.8,height:windowWidth*.8*.6 ,alignSelf:'center'}}>
        ...
        <Image style={{marginTop:5, top:'20%',right:'8%',position:'absolute'}}  source={require('../../assets/media/visa.png')}></Image>

        </View>

        <View style={allstyles.sec2}>
          <Text style={allstyles.cardNumberText} >**** **** **** {props.data.cardNumber}</Text>
          <Image style={{marginEnd:4, marginTop:4}} source={require('../../assets/media/sim.png')}></Image>
          <Image style={{marginTop:5}}  source={require('../../assets/media/wifi.png')}></Image>
        </View>
