...
<View>
  ...
  {enabled &&<Pressable onPress={()=>setModalVisible(true)}>
      <View style={{backgroundColor:'#007236', margin:20,width:windowWidth*.8,borderRadius:12.5 }}>
        <Text style={{color:'#FFFFFF',alignSelf:'center',fontWeight:'700',fontSize:16,padding:12}}>Pay Now</Text>
      </View>
    </Pressable>
    }
      {!enabled &&<Pressable disabled>
      <View style={{backgroundColor:'#737a7a', margin:20,width:windowWidth*.8,borderRadius:12.5 }}>
        <Text style={{color:'#FFFFFF',alignSelf:'center',fontWeight:'700',fontSize:16,padding:12}}>Pay Now</Text>
      </View>
    </Pressable>
    }
